...
public:
	StarkMetaEngineDetection() : SerializedMetaEngineDetection("stark_detection.json", g_adgfGameFlagNames, gameDescriptions, sizeof(DescribedADGameDescription), starkGames) {
