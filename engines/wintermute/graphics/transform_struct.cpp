...
/**
  * Returns a TransformStruct based on arguments provided. 
  * Has a number of overloads to accomodate various argument lists.
  */
...
bool TransformStruct::mirrorX() {
	return (bool) (_flip & TransparentSurface::FLIP_H);
}

bool TransformStruct::mirrorY() {
